...
let Financial = (props) =>{
    ...
    const ExampleCustomInput = React.forwardRef(({ value, onClick }, ref) => (
        <button className="btn btn-secondary btn-sm" onClick={onClick} ref={ref}>{value}</button>
    ));
    ...
    return(
        ...
        <div className="app-data-container financial-container">
            <div className="info-text">
                <h1 className="info-text-header">Financial overview</h1>
                <div>
                    <div className="info-text-box"><p className="lead">Provides statistics and graphical representations of data</p></div>
                </div>
            </div>
            <div className="alert alert-secondary">
                ...
                <div className="row financial-container-body">
                    ...
                    <div className="col-1">
                        <button className="btn btn-secondary btn-sm" onClick={()=>{fetchData()}}><span className="action-button-label"><span className="material-icons-outlined">refresh</span>Refresh</span></button>
                    </div>
                </div>
            </div> 
